...
\instrucao{Propaganda, marketing digital, redes sociais, relações públicas, promoção de vendas, endomarketing.}

\begin{tabularx}{\textwidth}{X r}
\toprule
\rowcolor{azul-claro}
\textbf{Ação / Canal} & \textbf{Orçamento Mensal} \\
\midrule
Mídias Sociais          & R\$ \tcampo{} \\
Google Ads / Meta Ads   & R\$ \tcampo{} \\
Eventos / Feiras        & R\$ \tcampo{} \\
Material Gráfico / Brindes & R\$ \tcampo{} \\
\bottomrule
\end{tabularx}
...
\midrule
\multicolumn{3}{@{}l}{\textbf{Custos Variáveis}} \\
\quad Custo de Mercadorias / Insumos  & \tcampo{} & \tcampo{} \\
\quad Comissões                       & \tcampo{} & \tcampo{} \\
\quad Frete / Logística               & \tcampo{} & \tcampo{} \\
\quad Impostos Variáveis              & \tcampo{} & \tcampo{} \\
\midrule
\multicolumn{3}{@{}l}{\textbf{Custos Fixos}} \\
\quad Aluguel                         & \tcampo{} & \tcampo{} \\
\quad Salários + Encargos             & \tcampo{} & \tcampo{} \\
\quad Pró-labore                      & \tcampo{} & \tcampo{} \\
\quad Água, Luz, Telefone             & \tcampo{} & \tcampo{} \\
\quad Internet / Sistemas             & \tcampo{} & \tcampo{} \\
\quad Marketing                       & \tcampo{} & \tcampo{} \\
\quad Contador / Assessoria           & \tcampo{} & \tcampo{} \\
\quad Seguros                         & \tcampo{} & \tcampo{} \\
\quad Depreciação                     & \tcampo{} & \tcampo{} \\
\quad Outros                          & \tcampo{} & \tcampo{} \\
\midrule
